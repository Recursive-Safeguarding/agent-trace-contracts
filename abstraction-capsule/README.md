...
and runs it through the sibling reference interpreter in `interpreter/`. The
specification, not this package, is normative.
...
against each of the other two, so the command prints two results as JSON. The
